...
public class WebServiceConfig extends WsConfigurerAdapter {
    ...
    public DefaultWsdl11Definition defaultWsdl11Definition(XsdSchema customerSchema) {
        ...
        wsdl11Definition.setTargetNamespace("http://www.xyz.com/apigateway/apigateway/adapter2XML/contract");
    ...
    public XsdSchema customerSchema() {
        return new SimpleXsdSchema(new ClassPathResource("def.xsd"));
    }
}