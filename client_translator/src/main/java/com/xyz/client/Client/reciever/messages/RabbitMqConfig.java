...
public class RabbitMqConfig {
    ...
    public static final String EXCHANGE_NAME = "json_exchange";
    public static final String ROUTING_KEY = "save_client";

    private static final String QUEUE_NAME = "client_queue";
